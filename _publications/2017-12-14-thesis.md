...
excerpt: 'In my dissertation, I explore models of non-local effects in biological systems. To study these nonlocal phenomena, I use iPDEs. The thesis has three chapters: (1) a derivation of non-local models from an underlying stochastic random walk; (2) an analysis of the steady-states of a non-local model of cell-cell adhesion; and (3) the construction of no-flux boundary conditions for a non-local model of cell-cell adhesion.'
date: 2018-06-07
